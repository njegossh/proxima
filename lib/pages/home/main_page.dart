...
class _HomeMainPageState extends State<HomeMainPage> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User>(
      stream: Database().userStream(currentUser.id),
        ...
        return ListenableBuilder(
          ...
          builder: (context, child) {
            return Scaffold(
                  ...
                  if (user.superuser)
                    Container(
                      ...
                      child: InkWell(
                        ...
                        child: const Icon(Icons.report, size: 25),
                      ),
                    ),
                  Container(
                    height: 30,
              ...
              body: {
                HomePage.courses: const SuggestedCoursesMainPage(),
                HomePage.chats: const ChatList(),
                HomePage.calendar: CalendarMainBody(user: user),
                HomePage.account: const AccountMainPage(),
              }[controller.page]!,
