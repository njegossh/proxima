  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, index) {
        return Scaffold(
        appBar: AppBar(elevation: 0, actions: [EditButton()],),
        body: controller.isLoading 
        ? Center(child: CircularProgressIndicator())
        : ListView(
          children: [
            SizedBox(height: 24,),
            Center(child: AvatarWidget(avatarURL: controller.account!.avatarURL)),
            SizedBox(height: 24,),
            Align(
            ...
            Center(child: InterestChips(listOfInterests: controller.account!.interests)),
            Align(
              ...
              child: SizedBox(
                child: Card(
                  child: Padding(
                    ...
                    child: Text(
                      controller.account!.description ?? '',
